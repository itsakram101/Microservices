...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleCustomerAlreadyExistsException(LoanAlreadyExistException exception,
                                                                         WebRequest webRequest){
    ...
    // final safeguard: handle unexpected or unanticipated errors.
